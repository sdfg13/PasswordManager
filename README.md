...
## Описание
Password Safe Pro — это десктопное приложение для управления учетными данными. В отличие от обычных текстовых менеджеров, здесь реализовано полное шифрование базы данных «на лету», что делает доступ к паролям невозможным без знания мастер-пароля.
